                    ...
                    <div class="col-md-12">
                      <div class="col-md-12">
                        <vuestic-simple-select
                          :label="'Izaberite željeni komentar'"
                          v-model="komentar"
                          name="komentar"
                          title=" "
                          ref="komentarSelect"
                          v-bind:options="komentari"
                        ></vuestic-simple-select>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  beforeCreate() {
    http
      ...
      .then((res) => {
        ...
        this.komentariGet = res.data.settings[0].komentari;
      });
  },
  created() {
    if (this.show) {
  ...
  methods: {
    ...
    open() {
      // console.log(this.comment[0].tip)

      switch (this.comment[0].tip) {
        ...
        default:
          this.komentari = this.komentariGet[2]
          break;
      }
      this.GetComment();
