                    ...
                    <fieldset>
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          />
                          <label class="control-label" for="date-picker-range-odT">{{ 'Od' }}</label>
                          <i class="bar"></i>
                        </div>&nbsp;&nbsp;
                        <div class="input-group">
                          <vuestic-date-picker
                          ...
                          />
                          <label class="control-label" for="date-picker-range-doT">{{ 'Do' }}</label>
                          <i class="bar"></i>
                        </div>
                      </div>
                    </fieldset>
...
export default {
  ...
  mounted() {
    bus.$on("TableSelected", () => {
      // console.log("Table selected.");
    });
    bus.$on("TableDateData", data => {
  ...
  methods: {
    ...
    Test(event) {
      bus.$emit("TableDateRange", "Date range changed.");
    },
    handleResize() {
