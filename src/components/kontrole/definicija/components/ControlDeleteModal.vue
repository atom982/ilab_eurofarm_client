            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <slot name="footer">
                  <button
                    type="button"
                    v-if="!noButtons && $store.state.access.level > 0"
                    :class="cancelClass"
                    @click="cancel"
                  ...
                  <button
                    type="button"
                    v-if="!noButtons && $store.state.access.level < 1"
                    :class="cancelClass"
                    @click="cancel"
                    :disabled="cancelDisabled"
                  >{{ cancelText }}</button>
...
export default {
  ...
  mounted() {
    bus.$on("ControlDeleteModalHide", () => {
      this.show = false;
    });
  },
  beforeDestroy() {
    bus.$off("ControlDeleteModalHide");
  },
  computed: {
    modalClass() {
      return {
