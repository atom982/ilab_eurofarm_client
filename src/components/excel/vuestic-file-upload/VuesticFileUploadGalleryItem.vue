<template>
  <div v-if="removed" class="file-upload-gallery-item">
    <vuestic-file-upload-undo class="file-upload-gallery-item-undo" @recover="recoverImage" />
  </div>
  ...
  <div v-else class="file-upload-gallery-item" :class="notGalleryItemClass">
    ...
    <div class="file-upload-gallery-item-overlay">
      <div class="file-upload-gallery-item-name" :title="file.name">{{ file.name }}</div>
      <div class="file-upload-gallery-item-size">{{ file.size }}</div>
      <button
        type="button"
