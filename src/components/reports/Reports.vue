    ...
    Download() {
      switch (this.izbor) {
        ...
        case "COVID 19 RT PCR Test":
          ...
          //       const link = document.createElement("a");
          //       link.href = url;
          //       link.setAttribute("download", "NEG" + this.timestamp + ".xlsx");
          //       document.body.appendChild(link);
          //       link.click();
        ...
        case "COVID 19 Antigen Test":
          ...
          //       const link = document.createElement("a");
          //       link.href = url;
          //       link.setAttribute("download", "POZ" + this.timestamp + ".xlsx");
          //       document.body.appendChild(link);
          //       link.click();
