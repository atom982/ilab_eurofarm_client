...
export default {
  ...
  mounted() {
    bus.$on("JsonEditAnalysersOpen", data => {      
      this.jsonData = data;
      this.obj = data;
      this.show = true;
    });
