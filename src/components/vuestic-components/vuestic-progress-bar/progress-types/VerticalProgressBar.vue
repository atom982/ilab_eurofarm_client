<template>
  <div class="vertical">
    <div class="progress" :class="size">
      <div class="progress-bar" ref="progressBar" :style="'height: ' + value + '%'"></div>
    </div>
...
export default {
  props: ["value", "animatedValue", "min", "max", "color", "size", "isActive"],
  mounted() {
...
.vuestic-progress-bar .vertical {
  .progress-bar {
    transition: background-color ease 0.5s, height 3s linear !important;
  }
