...
export default {
  name: "certificates-patient-entry",
  props: {
    transition: {
      type: String,
      default: "modal",
  ...
  data() {
    return {
      ...
      purpose: "Potvrda o prebolovanoj infekciji",
  ...
  watch: {
    purpose: function () {
      if (
        this.purpose === "Potvrda o prebolovanoj infekciji" ||
        this.purpose === "Potvrda o izvršenoj vakcinaciji" ||
        this.purpose != ""
      ) {
      ...
      if (
        ...
        if (this.validateJMBG(this.jmbg)) {
          ...
          this.symptoms = {
            ...
            otežanodisanjeiligubitakdaha: this.otežanodisanjeiligubitakdaha,
          ...
          // console.log('.post("certificates/unos/save/');
          this.protokol = "ECL";

          http
            .post("certificates/unos/save", {
              jmbg: jmbgPost,
                            ...
                            http
                              ...
                              .then((res4) => {
                                if (res4.data.success === false) {
                                  ...
                                  this.ime = "";
                                  this.purpose =
                                    "Potvrda o prebolovanoj infekciji";
                                  this.analysis = "";
                                  this.izdavanje = "DANAS";
                                  this.prezime = "";
                                  this.datum = "";
                                  this.nalaz = "";
                                  this.spol = "";
