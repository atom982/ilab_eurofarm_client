<template>
  <div class="form-elements">
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget headerText="Dodavanje korisnika">
          <form>
            <div class="row">
              <div class="col-md-6">
                <fieldset>
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="ime">{{'Unesite ime'}}</label>
                      <i class="bar"></i>
                    </div>
                  </div>
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      ...
                      <i class="glyphicon glyphicon-pencil icon-left input-icon"></i>
                      <label class="control-label" for="prezime">{{'Unesite prezime'}}</label>
                      <i class="bar"></i>
                    </div>
                  </div>
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      ...
                      <i class="glyphicon glyphicon-pencil icon-left input-icon"></i>
                      <label class="control-label" for="email">{{'Unesite korisničko ime'}}</label>
                      <i class="bar"></i>
                    </div>
                  </div>
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      ...
                      <i class="glyphicon glyphicon-pencil icon-left input-icon"></i>
                      <label class="control-label" for="password">{{'Unesite šifru'}}</label>
                      <i class="bar"></i>
                    </div>
                  </div>
                  <vuestic-simple-select
                    label="Vrsta korisničkog računa"
                    v-model="multi"
                    name="multi"
                    :required="true"
                    title=" "
                  ...
                  <button class="btn btn-sm btn-primary" @click.prevent="signUp">
...
export default {
  ...
  mounted() {
    http
      .get(
        "postavke/user/sajtovi/list?token=" +
  ...
  methods: {
    ...
    signUp() {
      ...
      if (
        this.multiSelectSajtovi.length < 1 ||
        this.site.trim() === "" ||
        this.email.trim() === "" ||
        this.password.trim() === "" ||
        this.multi.trim() === "" ||
        ...
        item = false;
        this.toastText = "Korisničko ime nije validno.";
        this.toastIcon = "fa-warning";
        this.toastPosition = "top-right";
        this.className = "vuestic-toast-warning";
      ...
      if (item) {
        ...
        this.multiSelectSajtoviID.forEach(element => {
          this.multiSelectSajtovi.forEach(site => {
            if (site === element.naziv) siteIDs.push(element._id);
          });
        });
        ...
        http
          ...
          .then(res => {
            ...
            if (res.data.message === "Username already exists.") {
              this.toastText = "Korisnik već postoji.";
              this.toastIcon = "fa-warning";
              this.toastPosition = "top-right";
              this.className = "vuestic-toast-warning";
