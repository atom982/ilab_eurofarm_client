  ...
  <aside class="sidebar">
    <vuestic-scrollbar>
      <ul class="sidebar-menu">
        <li @click="setDropdownDefaultIzbor()" v-for="item in sidebarItems" :key="item.name">
          <router-link
            :class="{'sidebar-link': item.meta.class === 'primary', 
              'sidebar-link-warning': item.meta.class === 'warning', 
              'sidebar-link-danger': item.meta.class === 'danger',
              'sidebar-link-info': item.meta.class === 'info'
            }"
            :to="item.path"
          ...
          <a
            ...
            class="sidebar-link"
            v-bind:class="{'sidebar-link-danger expanded': item.meta.expanded && item.meta.class === 'danger',
              'sidebar-link-info expanded': item.meta.expanded && item.meta.class === 'info' ,
              'sidebar-link-danger': !item.meta.expanded && item.meta.class === 'danger',
              'sidebar-link-info': !item.meta.expanded && item.meta.class === 'info'
            }"
            v-else
          >
            <i class="sidebar-menu-item-icon" v-bind:class="item.meta.iconClass"></i>
          ...
          <expanding>
            <ul class="sidebar-submenu in" v-show="item.meta.expanded">
              ...
              >
                ...
                >{{childItem.meta.title}}</router-link>
              </li>
            </ul>
          </expanding>
        </li>
  ...
  computed: {
    ...
    sidebarItems: function() {
      if (this.$store.state.access === undefined) {
        ...
        return this.menuItems.filter(i => i.meta.show);
      }
    }
  },
